...
(function (window, undefined) {
    ...
    K.selected = {
        simple: ['source', '|', 'fontname', 'fontsize', 'preview', '|', 'forecolor', 'hilitecolor', 'bold', 'italic', 'underline', 'removeformat', '|',
            'justifyleft', 'justifycenter', 'justifyright', 'insertorderedlist', 'insertunorderedlist', '|', 'table', 'image', 'link']
    };
