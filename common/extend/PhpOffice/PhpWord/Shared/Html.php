...
namespace common\extend\PhpOffice\PhpWord\Shared;

use common\extend\PhpOffice\PhpWord\Element\AbstractContainer;
use common\extend\PhpOffice\PhpWord\Element\Row;
use common\extend\PhpOffice\PhpWord\Element\Table;
use common\extend\PhpOffice\PhpWord\Settings;
use common\extend\PhpOffice\PhpWord\SimpleType\Jc;
use common\extend\PhpOffice\PhpWord\SimpleType\NumberFormat;
...
class Html
{
     ...
     *
     * @param \common\extend\PhpOffice\PhpWord\Element\AbstractContainer $element Where the parts need to be added
     ...
     * @param \common\extend\PhpOffice\PhpWord\Element\AbstractContainer $element object to add an element corresponding with the node
    ...
    protected static function parseNode($node, $element, $styles = array(), $data = array())
    {
        ...
        if (isset($nodes[$node->nodeName])) {
            ...
            $method = "parse{$method}";
            $newElement = call_user_func_array(array('common\extend\PhpOffice\PhpWord\Shared\Html', $method), $arguments);
     ...
     *
     * @param \DOMNode $node
     * @param \common\extend\PhpOffice\PhpWord\Element\AbstractContainer $element
     * @param array $styles
     * @param array $data
     */
     ...
     * @param \common\extend\PhpOffice\PhpWord\Element\AbstractContainer $element
     * @param array &$styles
     * @return \common\extend\PhpOffice\PhpWord\Element\TextRun
     */
     ...
     *
     * @param \DOMNode $node
     * @param \common\extend\PhpOffice\PhpWord\Element\Table $element
     * @param array &$styles
     * @return Row $element
     */
     ...
     * @param \common\extend\PhpOffice\PhpWord\Element\Table $element
     * @param array &$styles
     * @return \common\extend\PhpOffice\PhpWord\Element\Cell|\common\extend\PhpOffice\PhpWord\Element\TextRun $element
     */
            ...
            switch (trim($cKey)) {
                ...
                case 'line-height':
                    ...
                    if (preg_match('/([0-9]+\.?[0-9]*[a-z]+)/', $cValue, $matches)) {
                        ...
                        $spacingLineRule = \common\extend\PhpOffice\PhpWord\SimpleType\LineSpacingRule::EXACT;
                        $spacing = Converter::cssToTwip($matches[1]);
                    } elseif (preg_match('/([0-9]+)%/', $cValue, $matches)) {
                        //matches percentages
                        $spacingLineRule = \common\extend\PhpOffice\PhpWord\SimpleType\LineSpacingRule::AUTO;
                ...
                case 'width':
                    if (preg_match('/([0-9]+[a-z]+)/', $cValue, $matches)) {
                        ...
                        $styles['unit'] = \common\extend\PhpOffice\PhpWord\SimpleType\TblWidth::TWIP;
                    } elseif (preg_match('/([0-9]+)%/', $cValue, $matches)) {
                        $styles['width'] = $matches[1] * 50;
                        $styles['unit'] = \common\extend\PhpOffice\PhpWord\SimpleType\TblWidth::PERCENT;
                    } elseif (preg_match('/([0-9]+)/', $cValue, $matches)) {
                        $styles['width'] = $matches[1];
                        $styles['unit'] = \common\extend\PhpOffice\PhpWord\SimpleType\TblWidth::AUTO;
                    }
                    break;
                case 'border':
     ...
     * @param \common\extend\PhpOffice\PhpWord\Element\AbstractContainer $element
     *
     * @return \common\extend\PhpOffice\PhpWord\Element\Image
     **/
        ...
        foreach ($node->attributes as $attribute) {
            switch ($attribute->name) {
                ...
                case 'width':
                    ...
                    $style['width'] = $width;
                    $style['unit'] = \common\extend\PhpOffice\PhpWord\Style\Image::UNIT_PX;
                    break;
                case 'height':
                    ...
                    foreach ($styleattr as $attr) {
                        if (strpos($attr, ':')) {
                            ...
                            switch ($k) {
                                case 'float':
                                    if (trim($v) == 'right') {
                                        $style['hPos'] = \common\extend\PhpOffice\PhpWord\Style\Image::POS_RIGHT;
                                        $style['hPosRelTo'] = \common\extend\PhpOffice\PhpWord\Style\Image::POS_RELTO_PAGE;
                                        $style['pos'] = \common\extend\PhpOffice\PhpWord\Style\Image::POS_RELATIVE;
                                        $style['wrap'] = \common\extend\PhpOffice\PhpWord\Style\Image::WRAP_TIGHT;
                                        $style['overlap'] = true;
                                    }
                                    if (trim($v) == 'left') {
                                        $style['hPos'] = \common\extend\PhpOffice\PhpWord\Style\Image::POS_LEFT;
                                        $style['hPosRelTo'] = \common\extend\PhpOffice\PhpWord\Style\Image::POS_RELTO_PAGE;
                                        $style['pos'] = \common\extend\PhpOffice\PhpWord\Style\Image::POS_RELATIVE;
                                        $style['wrap'] = \common\extend\PhpOffice\PhpWord\Style\Image::WRAP_TIGHT;
                                        $style['overlap'] = true;
    ...
    /**
     * Transforms a HTML/CSS alignment into a \common\extend\PhpOffice\PhpWord\SimpleType\Jc
     *
