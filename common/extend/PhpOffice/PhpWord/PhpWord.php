...
use common\extend\PhpOffice\PhpWord\Element\Section;
...
class PhpWord
{
     ...
     *
     * @var \common\extend\PhpOffice\PhpWord\Element\Section[]
     */
    ...
    public function __construct()
    {
        ...
        foreach ($collections as $collection) {
            $class = 'common\\extend\\PhpOffice\\PhpWord\\Collection\\' . $collection;
        ...
        foreach ($metadata as $meta) {
            $class = 'common\\extend\\PhpOffice\\PhpWord\\Metadata\\' . $meta;
    ...
    public function __call($function, $args)
    {
        ...
        if (in_array($function, $addCollection)) {
            ...
            /** @var \common\extend\PhpOffice\PhpWord\Collection\AbstractCollection $collectionObject */
        ...
        if (in_array($function, $addStyle)) {
            return forward_static_call_array(array('common\\extend\\PhpOffice\\PhpWord\\Style', $function), $args);
        }
     ...
     *
     * @return \common\extend\PhpOffice\PhpWord\Metadata\DocInfo
     */
     ...
     * Get protection
     *
     * @return \common\extend\PhpOffice\PhpWord\Metadata\Protection
     * @since 0.12.0
     ...
     * Get compatibility
     *
     * @return \common\extend\PhpOffice\PhpWord\Metadata\Compatibility
     * @since 0.12.0
     */
     ...
     * Get compatibility
     *
     * @return \common\extend\PhpOffice\PhpWord\Metadata\Settings
     * @since 0.14.0
     */
     ...
     * Get all sections
     *
     * @return \common\extend\PhpOffice\PhpWord\Element\Section[]
     */
     ...
     *
     * @param int $index
     * @return \common\extend\PhpOffice\PhpWord\Element\Section|null
     */
     ...
     * @deprecated 0.12.0
     *
     * @param \common\extend\PhpOffice\PhpWord\Metadata\DocInfo $documentProperties
     *
     * @return self
     *
     * @codeCoverageIgnore
