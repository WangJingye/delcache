...
namespace common\extend\PhpOffice\PhpWord\Reader;
...
class Word2007 extends AbstractReader implements ReaderInterface
{
    ...
    {
        $partClass = "common\\extend\\PhpOffice\\PhpWord\\Reader\\Word2007\\{$partName}";
        if (class_exists($partClass)) {
            /** @var \common\extend\PhpOffice\PhpWord\Reader\Word2007\AbstractPart $part Type hint */
