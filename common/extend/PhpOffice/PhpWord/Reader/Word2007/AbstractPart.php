...
namespace common\extend\PhpOffice\PhpWord\Reader\Word2007;

use common\extend\PhpOffice\Common\XMLReader;
...
abstract class AbstractPart
{
     ...
     * Read w:p.
     *
     * @param \common\extend\PhpOffice\Common\XMLReader $xmlReader
     * @param \DOMElement $domNode
     * @param \common\extend\PhpOffice\PhpWord\Element\AbstractContainer $parent
    ...
    protected function readTable(XMLReader $xmlReader, \DOMElement $domNode, $parent, $docPart = 'document')
    {
        ...
        /** @var \common\extend\PhpOffice\PhpWord\Element\Table $table Type hint */
