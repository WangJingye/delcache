...
namespace common\extend\PhpOffice\PhpWord\Element;
 ...
 *
 * @method \common\extend\PhpOffice\PhpWord\Element\OLEObject addObject(string $source, mixed $style = null) deprecated, use addOLEObject instead
 *
 * @since 0.10.0
 */
abstract class AbstractContainer extends AbstractElement
{
     ...
     * Elements collection
     *
     * @var \common\extend\PhpOffice\PhpWord\Element\AbstractElement[]
     */
     ...
     * @param mixed $args
     * @return \common\extend\PhpOffice\PhpWord\Element\AbstractElement
     */
     ...
     *
     * @param int $index
     * @return \common\extend\PhpOffice\PhpWord\Element\AbstractElement|null
     */
     ...
     *
     * @param int|\common\extend\PhpOffice\PhpWord\Element\AbstractElement $toRemove
     */
    public function removeElement($toRemove)
    {
        ...
        } elseif ($toRemove instanceof \common\extend\PhpOffice\PhpWord\Element\AbstractElement) {
     ...
     * @param mixed $paragraphStyle
     *
     * @return \common\extend\PhpOffice\PhpWord\Element\Footnote
     *
     * @codeCoverageIgnore
     */
