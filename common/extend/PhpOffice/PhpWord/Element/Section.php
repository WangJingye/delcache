...
use common\extend\PhpOffice\PhpWord\ComplexType\FootnoteProperties;
use common\extend\PhpOffice\PhpWord\Style\Section as SectionStyle;
...
class Section extends AbstractContainer
{
     ...
     * Section style
     *
     * @var \common\extend\PhpOffice\PhpWord\Style\Section
     */
    private $style;
     ...
     * @param null|array|\common\extend\PhpOffice\PhpWord\Style $style
     */
     ...
     * Get section style
     *
     * @return \common\extend\PhpOffice\PhpWord\Style\Section
     */
    ...
    private function addHeaderFooter($type = Header::AUTO, $header = true)
    {
        ...
        if (in_array($type, array(Header::AUTO, Header::FIRST, Header::EVEN))) {
            ...
            /** @var \common\extend\PhpOffice\PhpWord\Element\AbstractContainer $container Type hint */
