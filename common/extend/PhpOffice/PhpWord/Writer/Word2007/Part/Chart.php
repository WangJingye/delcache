...
use common\extend\PhpOffice\PhpWord\Element\Chart as ChartElement;
...
class Chart extends AbstractPart
{
     ...
     * Chart element
     *
     * @var \common\extend\PhpOffice\PhpWord\Element\Chart
     */
    private $element;
     ...
     * Set chart element.
     *
     * @param \common\extend\PhpOffice\PhpWord\Element\Chart $element
     */
    ...
    private function writeSeriesItem(XMLWriter $xmlWriter, $type, $values)
    {
        ...
        foreach ($values as $value) {
            ...
            if (\common\extend\PhpOffice\PhpWord\Settings::isOutputEscapingEnabled()) {
