...
use common\extend\PhpOffice\PhpWord\Writer\Word2007\Style\TextBox as TextBoxStyleWriter;
...
class TextBox extends Image
{
    ...
    public function write()
    {
        ...
        if (!$element instanceof \common\extend\PhpOffice\PhpWord\Element\TextBox) {
            return;
        }
