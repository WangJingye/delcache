...
abstract class AbstractElement
{
     ...
     * XML writer
     *
     * @var \common\extend\PhpOffice\Common\XMLWriter
     */
    private $xmlWriter;
     ...
     * Get XML Writer
     *
     * @return \common\extend\PhpOffice\Common\XMLWriter
     */
     ...
     *
     * @uses \common\extend\PhpOffice\PhpWord\Writer\Word2007\Element\PageBreak::write()
     */
    ...
    private function writeTextStyle($styleType)
    {
        ...
        $class = "common\\extend\\PhpOffice\\PhpWord\\Writer\\Word2007\\Style\\{$styleType}";
        $styleObject = $this->element->$method();

        /** @var \common\extend\PhpOffice\PhpWord\Writer\Word2007\Style\AbstractStyle $styleWriter Type Hint */
