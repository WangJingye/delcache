...
class Field extends Text
{
    ...
    public function write()
    {
        ...
        if (!$element instanceof \common\extend\PhpOffice\PhpWord\Element\Field) {
            return;
        }
    ...
    private function writeDefault(\common\extend\PhpOffice\PhpWord\Element\Field $element)
    {
        ...
        if ($element->getText() != null) {
            if ($element->getText() instanceof \common\extend\PhpOffice\PhpWord\Element\TextRun) {
     ...
     * @param \common\extend\PhpOffice\PhpWord\Element\Field $element
     */
    protected function writeMacrobutton(\common\extend\PhpOffice\PhpWord\Element\Field $element)
    {
        $xmlWriter = $this->getXmlWriter();
        $this->startElementP();
    ...
    private function buildPropertiesAndOptions(\common\extend\PhpOffice\PhpWord\Element\Field $element)
    {
