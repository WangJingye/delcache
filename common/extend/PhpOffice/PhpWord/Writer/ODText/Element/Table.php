...
namespace common\extend\PhpOffice\PhpWord\Writer\ODText\Element;
...
class Table extends AbstractElement
{
    ...
    public function write()
    {
        ...
        if (!$element instanceof \common\extend\PhpOffice\PhpWord\Element\Table) {
            return;
        }
    ...
    private function writeRow(XMLWriter $xmlWriter, RowElement $row)
    {
        ...
        /** @var $row \common\extend\PhpOffice\PhpWord\Element\Row Type hint */
