...
namespace common\extend\PhpOffice\PhpWord\Writer\ODText\Style;
...
class Section extends AbstractStyle
{
    ...
    {
        /** @var \common\extend\PhpOffice\PhpWord\Style\Section $style Type hint */
        $style = $this->getStyle();
        if (!$style instanceof \common\extend\PhpOffice\PhpWord\Style\Section) {
            return;
        }
