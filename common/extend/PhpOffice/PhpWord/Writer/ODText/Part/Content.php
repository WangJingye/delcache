...
namespace common\extend\PhpOffice\PhpWord\Writer\ODText\Part;

use common\extend\PhpOffice\Common\XMLWriter;
use common\extend\PhpOffice\PhpWord\Element\AbstractContainer;
use common\extend\PhpOffice\PhpWord\Element\Image;
use common\extend\PhpOffice\PhpWord\Element\Table;
use common\extend\PhpOffice\PhpWord\Element\Text;
use common\extend\PhpOffice\PhpWord\Element\TextRun;
use common\extend\PhpOffice\PhpWord\Element\TrackChange;
use common\extend\PhpOffice\PhpWord\PhpWord;
use common\extend\PhpOffice\PhpWord\Style;
use common\extend\PhpOffice\PhpWord\Style\Font;
use common\extend\PhpOffice\PhpWord\Style\Paragraph;
use common\extend\PhpOffice\PhpWord\Style\Table as TableStyle;
use common\extend\PhpOffice\PhpWord\Writer\ODText\Element\Container;
use common\extend\PhpOffice\PhpWord\Writer\ODText\Style\Paragraph as ParagraphStyleWriter;
...
class Content extends AbstractPart
{
    ...
    private function writeAutoStyles(XMLWriter $xmlWriter)
    {
        ...
        foreach ($this->autoStyles as $element => $styles) {
            $writerClass = 'common\\extend\\PhpOffice\\PhpWord\\Writer\\ODText\\Style\\' . $element;
            foreach ($styles as $style) {
                /** @var \common\extend\PhpOffice\PhpWord\Writer\ODText\Style\AbstractStyle $styleWriter Type hint */
     ...
     *
     * @param \common\extend\PhpOffice\PhpWord\PhpWord $phpWord
     */
     ...
     *
     * @param \common\extend\PhpOffice\PhpWord\Element\AbstractContainer $container
    ...
    private function getContainerStyle($container, &$paragraphStyleCount, &$fontStyleCount)
    {
        ...
        foreach ($elements as $element) {
            if ($element instanceof TextRun) {
                ...
                /** @var \common\extend\PhpOffice\PhpWord\Style\Table $style */
                $style = $element->getStyle();
                if ($style === null) {
     ...
     *
     * @param \common\extend\PhpOffice\PhpWord\Element\Text $element
     * @param int $paragraphStyleCount
     * @param int $fontStyleCount
     */
     ...
     * @param \common\extend\PhpOffice\PhpWord\Element\AbstractElement[] $trackedChanges
     */
