...
class Container extends AbstractElement
{
     ...
     * @var string
     */
    protected $namespace = 'common\\extend\\PhpOffice\\PhpWord\\Writer\\HTML\\Element';
    ...
    public function write()
    {
        ...
        foreach ($elements as $element) {
            ...
            $writerClass = str_replace('common\\extend\\PhpOffice\\PhpWord\\Element', $this->namespace, $elementClass);
            if (class_exists($writerClass)) {
                /** @var \common\extend\PhpOffice\PhpWord\Writer\HTML\Element\AbstractElement $writer Type hint */
