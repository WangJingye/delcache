...
namespace common\extend\PhpOffice\PhpWord\Writer\HTML\Element;
...
class Table extends AbstractElement
{
    ...
    {
        if (!$this->element instanceof \common\extend\PhpOffice\PhpWord\Element\Table) {
            return '';
        }
     ...
     *
     * @param string|\common\extend\PhpOffice\PhpWord\Style\Table|null $tableStyle
     * @return string
     */
    private function getTableStyle($tableStyle = null)
    {
        ...
        if (is_string($tableStyle)) {
            ...
            $style = ' style="';
            if ($tableStyle->getLayout() == \common\extend\PhpOffice\PhpWord\Style\Table::LAYOUT_FIXED) {
                $style .= 'table-layout: fixed;';
            } elseif ($tableStyle->getLayout() == \common\extend\PhpOffice\PhpWord\Style\Table::LAYOUT_AUTO) {
