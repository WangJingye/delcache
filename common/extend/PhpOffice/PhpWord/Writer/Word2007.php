...
namespace common\extend\PhpOffice\PhpWord\Writer;

use common\extend\PhpOffice\PhpWord\Element\Section;
use common\extend\PhpOffice\PhpWord\Media;
...
class Word2007 extends AbstractWriter implements WriterInterface
{
     ...
     *
     * @param \common\extend\PhpOffice\PhpWord\PhpWord
     */
    public function __construct(PhpWord $phpWord = null)
    {
        ...
        foreach (array_keys($this->parts) as $partName) {
            ...
            if (class_exists($partClass)) {
                /** @var \common\extend\PhpOffice\PhpWord\Writer\Word2007\Part\AbstractPart $part Type hint */
                $part = new $partClass();
     ...
     *
     * @param \common\extend\PhpOffice\PhpWord\Shared\ZipArchive $zip
        ...
        if (!empty($elements)) {
            foreach ($elements as $file => $media) {
                if (count($media) > 0) {
                    ...
                    /** @var \common\extend\PhpOffice\PhpWord\Writer\Word2007\Part\AbstractPart $writerPart Type hint */
     ...
     *
     * @param \common\extend\PhpOffice\PhpWord\Element\Section &$section
     * @param \common\extend\PhpOffice\PhpWord\Shared\ZipArchive $zip
    ...
    private function addHeaderFooterContent(Section &$section, ZipArchive $zip, $elmType, &$rId)
    {
        ...
        /** @var \common\extend\PhpOffice\PhpWord\Element\AbstractElement $element Type hint */
    ...
    private function addNotes(ZipArchive $zip, &$rId, $noteType = 'footnote')
    {
        ...
        /** @var \common\extend\PhpOffice\PhpWord\Collection\AbstractCollection $collection Type hint */
    ...
    private function addChart(ZipArchive $zip, &$rId)
    {
        ...
        $index = 0;
        if ($collection->countItems() > 0) {
            /** @var \common\extend\PhpOffice\PhpWord\Element\Chart $chart */
