...
namespace common\extend\PhpOffice\PhpWord\Writer\RTF\Element;

use common\extend\PhpOffice\Common\Text as CommonText;
use common\extend\PhpOffice\PhpWord\Element\AbstractElement as Element;
use common\extend\PhpOffice\PhpWord\Escaper\Rtf;
use common\extend\PhpOffice\PhpWord\Settings;
use common\extend\PhpOffice\PhpWord\Style;
use common\extend\PhpOffice\PhpWord\Style\Font as FontStyle;
use common\extend\PhpOffice\PhpWord\Style\Paragraph as ParagraphStyle;
use common\extend\PhpOffice\PhpWord\Writer\AbstractWriter;
use common\extend\PhpOffice\PhpWord\Writer\HTML\Element\AbstractElement as HTMLAbstractElement;
use common\extend\PhpOffice\PhpWord\Writer\RTF\Style\Font as FontStyleWriter;
use common\extend\PhpOffice\PhpWord\Writer\RTF\Style\Paragraph as ParagraphStyleWriter;
...
abstract class AbstractElement extends HTMLAbstractElement
{
     ...
     * Font style
     *
     * @var \common\extend\PhpOffice\PhpWord\Style\Font
     */
    private $fontStyle;
     ...
     * Paragraph style
     *
     * @var \common\extend\PhpOffice\PhpWord\Style\Paragraph
     */
    ...
    {
        /** @var \common\extend\PhpOffice\PhpWord\Writer\RTF $parentWriter Type hint */
        $parentWriter = $this->parentWriter;

        /** @var \common\extend\PhpOffice\PhpWord\Element\Text $element Type hint */
