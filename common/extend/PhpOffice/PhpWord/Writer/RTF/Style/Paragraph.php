...
namespace common\extend\PhpOffice\PhpWord\Writer\RTF\Style;
...
class Paragraph extends AbstractStyle
{
    ...
    {
        $style = $this->getStyle();
        if (!$style instanceof \common\extend\PhpOffice\PhpWord\Style\Paragraph) {
            return '';
        }
    ...
    /**
     * Writes an \common\extend\PhpOffice\PhpWord\Style\Indentation
     *
     * @param null|\common\extend\PhpOffice\PhpWord\Style\Indentation $indent
     * @return string
     */
    private function writeIndentation($indent = null)
    {
        if (isset($indent) && $indent instanceof \common\extend\PhpOffice\PhpWord\Style\Indentation) {
     ...
     * Writes tabs
     *
     * @param \common\extend\PhpOffice\PhpWord\Style\Tab[] $tabs
     * @return string
     */
