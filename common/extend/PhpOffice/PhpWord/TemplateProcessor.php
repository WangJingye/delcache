...
use common\extend\PhpOffice\Common\Text;
use common\extend\PhpOffice\Common\XMLWriter;
use common\extend\PhpOffice\PhpWord\Escaper\RegExp;
use common\extend\PhpOffice\PhpWord\Escaper\Xml;
use common\extend\PhpOffice\PhpWord\Exception\CopyFileException;
use common\extend\PhpOffice\PhpWord\Exception\CreateTemporaryFileException;
use common\extend\PhpOffice\PhpWord\Exception\Exception;
use common\extend\PhpOffice\PhpWord\Shared\ZipArchive;
...
class TemplateProcessor
{
     ...
     *
     * @throws \common\extend\PhpOffice\PhpWord\Exception\CreateTemporaryFileException
     * @throws \common\extend\PhpOffice\PhpWord\Exception\CopyFileException
     */
     ...
     *
     * @return \common\extend\PhpOffice\PhpWord\Shared\ZipArchive
     */
    public function zip()
    {
     ...
     *
     * @throws \common\extend\PhpOffice\PhpWord\Exception\Exception
     *
     * @return string
     */
    ...
    /**
     * @param string $search
     * @param \common\extend\PhpOffice\PhpWord\Element\AbstractElement $complexType
     */
    public function setComplexValue($search, \common\extend\PhpOffice\PhpWord\Element\AbstractElement $complexType)
    {
        $elementName = substr(get_class($complexType), strrpos(get_class($complexType), '\\') + 1);
        $objectClass = 'common\\extend\\PhpOffice\\PhpWord\\Writer\\Word2007\\Element\\' . $elementName;

        $xmlWriter = new XMLWriter();
        /** @var \common\extend\PhpOffice\PhpWord\Writer\Word2007\Element\AbstractElement $elementWriter */
     ...
     * @param \common\extend\PhpOffice\PhpWord\Element\AbstractElement $complexType
     */
    public function setComplexBlock($search, \common\extend\PhpOffice\PhpWord\Element\AbstractElement $complexType)
    {
        $elementName = substr(get_class($complexType), strrpos(get_class($complexType), '\\') + 1);
        $objectClass = 'common\\extend\\PhpOffice\\PhpWord\\Writer\\Word2007\\Element\\' . $elementName;
     ...
     * @return \common\extend\PhpOffice\PhpWord\TemplateProcessor Fluent interface
     */
