...
use common\extend\PhpOffice\PhpWord\ComplexType\TblWidth as TblWidthComplexType;
use common\extend\PhpOffice\PhpWord\SimpleType\Jc;
use common\extend\PhpOffice\PhpWord\SimpleType\JcTable;
use common\extend\PhpOffice\PhpWord\SimpleType\TblWidth;

class Table extends Border
{
    /**
     * @deprecated Use \common\extend\PhpOffice\PhpWord\SimpleType\TblWidth::AUTO instead
     */
    const WIDTH_AUTO = 'auto'; // Automatically determined width
    /**
     * @deprecated Use \common\extend\PhpOffice\PhpWord\SimpleType\TblWidth::PERCENT instead
     */
    const WIDTH_PERCENT = 'pct'; // Width in fiftieths (1/50) of a percent (1% = 50 unit)
    /**
     * @deprecated Use \common\extend\PhpOffice\PhpWord\SimpleType\TblWidth::TWIP instead
     */
     ...
     * Style for first row
     *
     * @var \common\extend\PhpOffice\PhpWord\Style\Table
     */
     ...
     * Position
     *
     * @var \common\extend\PhpOffice\PhpWord\Style\TablePosition
     */
    private $position;
     ...
     * Get position
     *
     * @return \common\extend\PhpOffice\PhpWord\Style\TablePosition
     */
