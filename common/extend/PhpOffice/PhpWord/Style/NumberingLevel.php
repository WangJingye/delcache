...
class NumberingLevel extends AbstractStyle
{
    ...
    /**
     * Numbering format w:numFmt, one of common\extend\PhpOffice\PhpWord\SimpleType\NumberFormat
     *
     * @var string
     ...
     *
     * @var string, one of common\extend\PhpOffice\PhpWord\SimpleType\Jc
     */
    private $alignment = '';
