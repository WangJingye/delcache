...
namespace common\extend\PhpOffice\PhpWord\Metadata;

use common\extend\PhpOffice\PhpWord\ComplexType\ProofState;
use common\extend\PhpOffice\PhpWord\ComplexType\TrackChangesView;
use common\extend\PhpOffice\PhpWord\SimpleType\Zoom;
use common\extend\PhpOffice\PhpWord\Style\Language;
...
class Settings
{
     ...
     * @var mixed either integer, in which case it treated as a percent, or one of common\extend\PhpOffice\PhpWord\SimpleType\Zoom
     */
    private $zoom = 100;
     ...
     *
     * @var \common\extend\PhpOffice\PhpWord\ComplexType\ProofState
     */
    private $proofState;
     ...
     *
     * @var \common\extend\PhpOffice\PhpWord\Metadata\Protection
     */
     ...
     *
     * @return \common\extend\PhpOffice\PhpWord\ComplexType\TrackChangesView
     */
