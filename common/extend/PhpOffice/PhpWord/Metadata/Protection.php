...
use common\extend\PhpOffice\PhpWord\SimpleType\DocProtect;
...
class Protection
{
    ...
    /**
     * Cryptographic Hashing Algorithm (see constants defined in \common\extend\PhpOffice\PhpWord\Shared\Microsoft\PasswordEncoder)
     *
     * @var string
     */
     ...
     *
     * @param string $editing Any value of \common\extend\PhpOffice\PhpWord\SimpleType\DocProtect
     * @return self
     */
