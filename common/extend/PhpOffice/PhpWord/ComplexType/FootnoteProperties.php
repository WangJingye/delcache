...
namespace common\extend\PhpOffice\PhpWord\ComplexType;
...
final class FootnoteProperties
{
    ...
    /**
     * Footnote Numbering Format w:numFmt, one of common\extend\PhpOffice\PhpWord\SimpleType\NumberFormat
     *
     * @var string
     */
    private $numFmt;
