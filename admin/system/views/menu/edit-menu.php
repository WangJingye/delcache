<form id="save-form" action="<?= $this->createUrl('system/menu/editMenu') ?>" method="post">
    ...
    <div class="form-group row">
        <label class="col-sm-2 col-form-label">功能类型</label>
        <div class="col-sm-10">
    ...
    <div class="form-group row">
        <label class="col-sm-2 col-form-label">父级功能</label>
        <div class="col-sm-10">
    ...
    <div class="form-group row">
        <label class="col-sm-2 col-form-label">图标样式</label>
        <div class="col-sm-10">
    ...
    <div class="form-group row">
        <label class="col-sm-2 col-form-label">菜单描述</label>
        <div class="col-sm-10">
            <textarea name="desc"
